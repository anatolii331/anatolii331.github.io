...
for row_index, row in enumerate(datareader):
	...
	# Othrwise, create a YAML file from the data in this row...
		...
		# Open a new file with filename based on the first column "2019-08-26-" + 
		filename = row[18].lower().replace(" county", "").replace(" ", "_") + '.md'
		...
		yaml_text += "permalink: /:basename/ \n"

		# yaml_text += "categories: [ " + row[7] + "," + row[12] + " ] \n"
